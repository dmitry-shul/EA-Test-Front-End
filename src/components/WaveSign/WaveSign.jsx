import styles from "./WaveSign.module.css"

const WaveSign = ({text}) => {
  return (
    <div className={styles.sign} style={{backgroundImage: "url('./assets/images/waveSign.png')"}}>
      {/*<svg className={styles.svg} width="132" height="54" viewBox="0 0 132 54" fill="none" xmlns="http://www.w3.org/2000/svg">
